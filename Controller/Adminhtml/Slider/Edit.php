...
class Edit extends Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Chandu_Bannerslider::bannerslider')
            ->addBreadcrumb(__('Bannerslider'), __('Bannerslider'))
            ->addBreadcrumb(__('Manage Bannerslider'), __('Manage Bannerslider'));
        return $resultPage;
    }
    /**
     * Edit CMS page
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? __('Edit "%1"', $model->getTitle()) : __('New Bannerslider'));
